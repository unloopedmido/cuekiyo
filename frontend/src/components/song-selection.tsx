...
export function SongSelection({
  ...
  const submit = (confirmFewer: boolean) => {
    setSubmitting(true)
    ...
    <section className="flex flex-col gap-6">
      ...
      <AlertDialog open={confirmFewerOpen} onOpenChange={setConfirmFewerOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>
              Fewer than {project.songs_count} songs?
            </AlertDialogTitle>
            <AlertDialogDescription>
              You picked {selected.size}. The compilation will be shorter than
              planned.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
