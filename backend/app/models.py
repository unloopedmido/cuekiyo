...
class Project(Base):
    ...
    fade_seconds: Mapped[float] = mapped_column(Float, default=0.5)
    unlimited_songs: Mapped[bool] = mapped_column(Boolean, default=False)
...
class Song(Base):
    ...
    clip_time: Mapped[float | None] = mapped_column(Float, nullable=True)
